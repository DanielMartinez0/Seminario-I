...
\input{committee}
\input{misc/dedication_udea}
%\input{misc/declaration_udea}
\input{misc/acknowledgement_udea}
\input{misc/abstract_udea}
...
\input{intro_udea}
\input{background_udea}
\input{Conclusions_udea}
%
%\input{discussion2}
...
\bibliography{biblio_udea,publications_udea}
